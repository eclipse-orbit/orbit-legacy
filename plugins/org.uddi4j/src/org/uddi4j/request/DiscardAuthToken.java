 ...
 * <p>This optional message is used to deactivate an authentication token
...
public class DiscardAuthToken extends UDDIElement {
   ...
   public static final String UDDI_TAG = "discard_authToken";
    ...
    */
   public DiscardAuthToken(String authInfo) {
    ...
    */
   public DiscardAuthToken(Element base) throws UDDIException {
